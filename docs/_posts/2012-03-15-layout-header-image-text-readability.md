...
|:--------|:-------:|--------:|
| Unintended Startup   | Vehicle needs to be in neutral, parking brakes need to be applied, operator needs to be in seat and seat belt is worn to enable startup   
| Dual channel (primary and redundant signals)   * Joystick transmission modes (N/F/R) * Brake pressure sensors  * Operator seat contact sensor  * Seat belt sensor   |
