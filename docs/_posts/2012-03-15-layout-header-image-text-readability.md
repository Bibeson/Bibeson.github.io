...
|:--------|:-------:|--------:|
| Unintended Startup   | Vehicle needs to be in neutral, parking brakes need to be applied, operator needs to be in seat and seat belt is worn to enable startup   | Dual channel (primary and redundant signals) <br> <ul><li>Joystick transmission modes (N/F/R)</li><li>Brake pressure sensors</li></ul> <ul><li>Operator seat contact sensor<br></li><li>Seat belt sensor</li></ul>  |
